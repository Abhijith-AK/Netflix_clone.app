...
class _$_Downloads implements _Downloads {
  ...
  @override
  String toString() {
    return 'Downloads(posterPath: $posterPath, title: $title, originalName: $originalName, backdropPath: $backdropPath)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, posterPath, title, originalName, backdropPath);
